...
public class Method2 {
	...
	// 반환도 없고 매개변수도 없는 메소드
	public static void test1() { // void = 값이 없다 = return(반환) 값이 없다
	...
	public static void main(String[] args) {
		...
		System.out.println(result); //return된 값이 여기에 출력된다
		System.out.println(result); 
		System.out.println(result); //test5호출은 한번이었기 때문에 다음 result부터는 return값만 나온다
